...
WReaderDIP::WReaderDIP( std::string fname ) :
                WReader( fname )
{
}

WReaderDIP::ReturnCode::Enum WReaderDIP::read( boost::shared_ptr< WDataSetEMMSurface > surface )
{
    ifstream ifs;
    ...
    if( surface->getFaces().empty() )
    {
        ...
        WGeometry::computeTriangulation( surface->getFaces(), *surface->getVertex() );
    }
...
WReaderDIP::ReturnCode::Enum WReaderDIP::readUnit( string& line, boost::shared_ptr< WDataSetEMMSurface > surface )
{
...
WReaderDIP::ReturnCode::Enum WReaderDIP::readNumPos( string& line, size_t& count )
{
    vector< string > tokens = string_utils::tokenize( line );
...
WReaderDIP::ReturnCode::Enum WReaderDIP::readNumPoly( string& line, size_t& count )
{
    vector< string > tokens = string_utils::tokenize( line );
    count = string_utils::fromString< size_t >( tokens.at( 1 ) );
...
WReaderDIP::ReturnCode::Enum WReaderDIP::readPositions( ifstream& ifs, size_t count,
...
WReaderDIP::ReturnCode::Enum WReaderDIP::readPolygons( ifstream& ifs, size_t count,
                boost::shared_ptr< WDataSetEMMSurface > surface )
{
