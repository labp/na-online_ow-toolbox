...
#ifndef WFIRFILTERCPU_TEST_H
#define WFIRFILTERCPU_TEST_H
...
public:
    ...
    void test_filterImpulse( void )
    {
        ...
        filter.reset( new WFIRFilterCpu( WFIRFilter::WEFilterType::BANDPASS, WLWindowsFunction::HAMMING, ORDER, SFREQ,
        C1FREQ, C2FREQ ) );
        WFIRFilterTestHelper::filterImpulseTest( filter );
    }
