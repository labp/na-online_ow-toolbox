...
void WLDaqNeuromag::applyIntegrationPoints3012( WLMegCoilInfo* const megCoil )
{
    ...
    megCoil->integrationPoints.col( 0 ) = ip1;
    megCoil->integrationPoints.col( 1 ) = ip2;
    megCoil->integrationPoints.col( 2 ) = ip3;
    megCoil->integrationPoints.col( 3 ) = ip4;
    megCoil->integrationPoints.col( 4 ) = ip5;
    megCoil->integrationPoints.col( 5 ) = ip6;
    megCoil->integrationPoints.col( 6 ) = ip7;
    megCoil->integrationPoints.col( 7 ) = ip8;
    ...
    megCoil->integrationPoints.col( 8 ) = ip1;
    megCoil->integrationPoints.col( 9 ) = ip2;
    megCoil->integrationPoints.col( 10 ) = ip3;
    megCoil->integrationPoints.col( 11 ) = ip4;
    megCoil->integrationPoints.col( 12 ) = ip5;
    megCoil->integrationPoints.col( 13 ) = ip6;
    megCoil->integrationPoints.col( 14 ) = ip7;
    megCoil->integrationPoints.col( 15 ) = ip8;
...
void WLDaqNeuromag::applyIntegrationPoints3022( WLMegCoilInfo* const megCoil )
{
    ...
    megCoil->integrationPoints.col( 6 ) = ip7;
    megCoil->integrationPoints.col( 7 ) = ip8;
    megCoil->integrationPoints.col( 8 ) = ip9;
