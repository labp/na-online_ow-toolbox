...
namespace LaBP
{
    class WDataSetEMMECG: public WDataSetEMMEMD
    {
    public:
        /**
         * Abbreviation for a shared pointer.
         */
        typedef boost::shared_ptr< WDataSetEMMECG > SPtr;

        /**
         * Abbreviation for const shared pointer.
         */
        typedef boost::shared_ptr< const WDataSetEMMECG > ConstSPtr;
        ...
        explicit WDataSetEMMECG( const WDataSetEMMECG& ecg );

        /**
         * TODO(kaehler): Comments
         */
        virtual ~WDataSetEMMECG();
